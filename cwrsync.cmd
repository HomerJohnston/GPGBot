...
@ECHO ON
rsync -e "ssh -o 'StrictHostKeyChecking no' -p 1939 -i /cygdrive/c/Users/KWilcox/.ssh/Swordfish" -r -z "/cygdrive/x/GPGBot/bin/Release/net6.0/publish/linux-x64/." "ubuntu@swordfish.ghostpeppergames.com:/opt/gpgbot"
